...
- 1,073 current facts and 1,158 total fact versions.
- 847 current Aramco data points and 932 total versions, plus 37 profile attributes, four ownership positions, 13 disclosures, eight corporate actions, 23 official daily market-price rows, and 15 point-in-time valuation metrics. Aramco 2025 alone contains 380 current rows across 282 distinct metrics. Coverage includes detailed financial, segment, operational, ESG, commercial, commitment, tax, credit-risk, lease, and annual history for 2019–2025, plus discrete Q1/H1 2026 semantics.
...
- Aramco currently populates 355 of 507 applicable catalog fields (70.0%). The commercial pipeline keeps the SAR 5.358 billion advance tied to a long-term sales agreement as a numeric fact, while a 20-year Jafurah minimum-volume arrangement is retained as qualitative evidence because no committed volume was disclosed. Financial notes are now 45/66, investor analytics 13/30, valuation 15/17, per-share 6/6, and liquidity/solvency 13/14.
- All 555 directly sourced Aramco facts resolve to an extraction row and archived official artifact. Read-only fact responses expose source URL/key, report page/table, extraction label/value, mapping confidence/method, archive path and SHA-256. Calculated facts expose their deterministic formula and dependencies.
