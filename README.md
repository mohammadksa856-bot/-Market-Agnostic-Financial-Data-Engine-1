# Market-Agnostic Financial Data Engine 1.8
...
The bundled portable snapshot is rebuilt from 40 reviewed manifests and currently contains:

- 5 enabled companies: Saudi Aramco, SABIC, Apple, Microsoft, and NVIDIA.
- 1,412 current facts and 1,502 total fact versions.
...
- SABIC is the first Saudi generalization acceptance pilot: its official 2025 integrated report is archived by SHA-256. The snapshot now publishes 193 sourced facts plus 32 calculated facts. It covers the core statements, production and sales volumes, segment and geographic revenue, segment EBIT/EBITDA/assets/liabilities/capex/investments, five-year dividends and year-end market history, company profile, ownership, corporate actions, disclosures, resource intensity, emissions, process safety, innovation, workforce, and suppliers. SABIC populates 171 of 653 applicable catalog fields (26.2%) and all 28 core required fields. Every sourced fact retains its report page and table reference.
