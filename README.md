...
- Aramco currently populates 371 of 507 applicable catalog fields (73.2%). The commercial pipeline keeps the SAR 5.358 billion advance tied to a long-term sales agreement as a numeric fact, while a 20-year Jafurah minimum-volume arrangement is retained as qualitative evidence because no committed volume was disclosed. Financial notes are now 54/66, oil-and-gas operations 31/46, investor analytics 13/30, valuation 15/17, per-share 6/6, and liquidity/solvency 13/14. Operational gaps that are absent from the archived annual report are explicitly classified as non-disclosed instead of being presented as pending extraction.
