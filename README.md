# Market-Agnostic Financial Data Engine 1.7
...
The bundled portable snapshot is rebuilt from 39 reviewed manifests and currently contains:

- 5 enabled companies: Saudi Aramco, SABIC, Apple, Microsoft, and NVIDIA.
- 1,301 current facts and 1,391 total fact versions.
...
- SABIC is the first Saudi generalization pilot: its official 2025 integrated report is archived by SHA-256. The snapshot now publishes 90 sourced facts plus 24 calculated facts. The sector pass adds 31 source-linked facts covering production and sales volumes for Chemicals, Polymers, and Agri-Nutrients, segment revenue/EBIT/EBITDA/assets/liabilities/capex/investments, and safety. SABIC populates 105 of 632 applicable catalog fields (16.6%) and 26 of 28 core required fields. Every new fact retains its report page and table reference.
...
- Database schema version 14, catalog version 9, and 64 unit/integration/release tests (six PDF-reader tests require the optional reader dependency).
