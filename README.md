# Market-Agnostic Financial Data Engine 1.9
...
The bundled portable snapshot is rebuilt from 42 reviewed manifests and currently contains:

- 5 enabled companies: Saudi Aramco, SABIC, Apple, Microsoft, and NVIDIA.
- 1,666 current facts and 1,758 total fact versions.
...
- SABIC is the first Saudi generalization acceptance pilot: its official 2025 integrated report is archived by SHA-256. The snapshot now publishes 387 sourced facts plus 92 calculated facts. It covers the 2025 statements and the restated 2024 comparative, detailed PPE and intangibles, cash and receivables, debt instruments and maturities, leases, employee benefits, provisions, related parties, tax components, commitments, production and sales volumes, segment and geographic revenue, five-year dividends and year-end market history, company profile, ownership, corporate actions, disclosures, resource intensity, emissions, process safety, innovation, workforce, and suppliers. SABIC populates 284 of 653 applicable catalog fields (43.5%) and all 28 core required fields. Every sourced fact retains its report page and table reference; the comparative period now drives deterministic growth, efficiency, solvency, per-share, and valuation calculations.
