...
- 1,148 current facts and 1,233 total fact versions.
- 922 current Aramco data points and 1,007 total versions, plus 37 profile attributes, four ownership positions, 13 disclosures, eight corporate actions, 23 official daily market-price rows, and 15 point-in-time valuation metrics. Aramco 2025 alone contains 419 current rows across 297 distinct metrics. Coverage includes detailed financial, segment, operational, ESG, commercial, commitment, tax, credit-risk, lease, geographic revenue, PPE movements, and annual history for 2019–2025, plus discrete Q1/H1 2026 semantics.
...
- Aramco currently populates 370 of 507 applicable catalog fields (73.0%). The commercial pipeline keeps the SAR 5.358 billion advance tied to a long-term sales agreement as a numeric fact, while a 20-year Jafurah minimum-volume arrangement is retained as qualitative evidence because no committed volume was disclosed. Financial notes are now 54/66, investor analytics 13/30, valuation 15/17, per-share 6/6, and liquidity/solvency 13/14.
