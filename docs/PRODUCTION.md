...
| Saudi issuer-report monitor | Live SABIC acceptance follows Saudi Exchange announcements and published a real Q2 2026 PDF as 90 current facts. Live Al Rajhi acceptance follows its official investor page to the issuer's Oracle object store, archived the Q2 2026 XLSX, verified 1,295 sourced facts with 139 checks, and published 1,824 sourced/calculated points across FY, quarter, YTD, and instant semantics with zero exceptions | Verify discovery and unusual layouts on acceptance issuers from insurance, telecom, utilities, and the remaining sectors before batch activation |
