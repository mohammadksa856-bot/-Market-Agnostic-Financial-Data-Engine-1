...
Originally prepared on `claude/data-cement-3` and integrated into `main` after
current-engine verification. Source-faithful manifests were transcribed by hand
from each issuer's official FY2025 audited financial statements (the full
