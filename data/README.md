...
1,011 current facts across Saudi Aramco, Apple, Microsoft, and NVIDIA. Aramco contributes 785
current facts (870 total versions), 23 official daily price rows, and 15 point-in-time valuation metrics. The seed
...
Schema v12 includes a reviewed 502-field commercial target catalog. The universal company pack
contains 433 fields across company model, statements, dimensional financial notes, commercial sales/order backlog, investor analytics,
consensus estimates, market data, ownership, corporate actions, and disclosures. Integrated Oil & Gas
companies receive another 69 segment and operating fields. Aramco currently populates 339 fields (67.5%);
